...
<html class="ks-webkit537 ks-webkit ks-chrome39 ks-chrome"><head><meta http-equiv="Content-Type" content="text/html; charset=GBK">
 ...
 <link rel="stylesheet" href="http://g.alicdn.com/tb/??global/3.4.4/global-min.css,item-detail/5.1.0/index-min.css">
<link charset="utf-8" href="http://g.alicdn.com/ccc/address-detail/1.0.8/??wlroute.css" rel="stylesheet">
<link charset="utf-8" href="http://g.alicdn.com/tbc/??header/1.4.6/index-min.css,search-suggest/1.3.5/new_suggest-min.css" rel="stylesheet">
<link charset="utf-8" href="http://g.alicdn.com/tb/relationrecommendplug/1.4.6/recommend/??detail/page_pine_module/page_pine_module-min.css" rel="stylesheet">
...
<div class="tb-header-logo">
    <a href="http://www.taobao.com/" target="_blank" title="淘宝网">
        <img height="38" alt="淘宝网logo" src="./images/index/logo.png">
    </a>
...
<div class="tb-summary tb-clear">
 ...
 <img id="J_ImgBooth"  data-haszoom="700" src=<%=item.getDefaultUrl() %>>
...
<ul id="J_UlThumb" class="tb-thumb tb-clearfix" >
    <%
    	sql="select url from material where type="+Constant.MATERIAL_DISPLAY_TYPE_BRAND+" and itemCode='" + itemCode + "'";
		rs = JdbcTemplate.excuteQuery(sql);
    	List<String> materialList = new ArrayList<String>();
    	while(rs.next()){
    		materialList.add(rs.getString(1));
    	}
...
<i class="tb-icon"></i> 收藏宝贝<em class="J_FavCount"> (<%=item.getCollectTimes() %>人气)</em>
 ...
 <h3 class="tb-main-title" data-title="2015欧根纱半身裙高腰蓬蓬裙网纱伞裙中裙春半裙夏裙子">
   ...
   <div id="J_TEditItem" class="tb-editor-menu">	        <div id="J_Report" class="tb-report">                	<p class="tb-report-hd">举报</p>                	<ul class="tb-report-bd">                		<li><a id="J_isuit" href="http://archer.taobao.com/myservice/report/entry.htm?spm=2013.1.1000373.1.7aae99&display_type=3&auction_num_id=44788503208" target="_blank">举报此商品</a></li>                		<li><a href="http://bbs.taobao.com/catalog/thread/154504-977100.htm?spm=2013.1.1000373.2" target="_blank">商品举报演示</a></li>                		<li><a href="http://bbs.taobao.com/catalog/424023.htm?spm=2013.1.1000373.3" target="_blank">购物安全防骗</a></li>                		<li><a href="http://315.taobao.com/?spm=2013.1.1000373.4" target="_blank">消费质量曝光</a></li>                	</ul>            </div></div>
 </div>
...
<li class="tb-clearfix" id="J_OtherDiscount">
 ...
 <strong id="J_SellCounter"><%=item.getViewTimes() %></strong>
 <span>交易成功</span>
 </a>
 </div>
 </div>
...
<div class="tb-btn-buy"><a href="./buyItem.jsp?color=10001&size=10103&itemCode=<%=itemCode %>"  data-addfastbuy="true" title="点击此按钮，到下一步确认购买信息" class="J_LinkBuy" data-spm-click="gostr=/tbdetail;locaid=d1" shortcut-key="b" shortcut-label="立即购买" shortcut-effect="click">立即购买</a></div>
